    ...
    <section id="about" className="py-20 bg-background">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          {/* Content */}
          <div>
            <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-6 text-high-contrast">
              Transforming Ideas into Digital Success Stories
            </h3>
            
            <div className="space-y-4 text-foreground leading-relaxed mb-8 text-readable">
              <p>
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-semibold text-foreground text-high-contrast">Flutter & React Native Experts</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-accent rounded-full"></div>
                <span className="text-sm font-semibold text-foreground text-high-contrast">MERN Stack Specialists</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-accent rounded-full"></div>
                <span className="text-sm font-semibold text-foreground text-high-contrast">Custom ERP Solutions</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-accent rounded-full"></div>
                <span className="text-sm font-semibold text-foreground text-high-contrast">24/7 Support</span>
              </div>
            </div>
          </div>
            ...
            {achievements.map((achievement, index) => (
              <Card key={index} className="text-center p-6 bg-gradient-subtle border-border">
                <CardContent className="p-0">
                  <div className="text-4xl font-bold text-primary mb-2 text-high-contrast">
                    {achievement.number}
                  </div>
                  <div className="text-foreground font-semibold text-high-contrast">
                    {achievement.label}
                  </div>
                </CardContent>
              </Card>
        ...
        {/* Values Section */}
        <div>
          <h3 className="text-2xl md:text-3xl font-bold text-center text-foreground mb-12 text-high-contrast">
            Our Core Values
          </h3>
            ...
            {values.map((value, index) => (
              <Card key={index} className="text-center p-6 service-card bg-card border-border group">
                <CardContent className="p-0">
                  ...
                  <h4 className="text-lg font-semibold text-foreground mb-3 group-hover:text-primary transition-colors text-high-contrast">
                    {value.title}
                  </h4>
                  <p className="text-sm text-foreground leading-relaxed text-readable">
                    {value.description}
                  </p>
                </CardContent>
              </Card>
